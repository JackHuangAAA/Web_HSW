<template>
  <div class="lack-inventory">
    <Row>
      <div class="lack-inventory-title">
        <p class="lack-inventory-icon"></p>
        <p>缺少库存疫苗</p>
        <div class="lack-number">
          2种
        </div>
        <div class="lack-notice">
