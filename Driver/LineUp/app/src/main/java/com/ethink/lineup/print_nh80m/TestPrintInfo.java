...
//		}
	...
	public int TestCashDrawerOpen(POSSDK pos_sdk,int printMode,int CashdrawerID, int PulseOnTimes, int PulseOffTimes ) {
		...
		error_code = pos_sdk.cashdrawerOpen(CashdrawerID, PulseOnTimes, PulseOffTimes);
		if(error_code != POS_SUCCESS)
		{
			return error_code;
		}
	...
	public int TestPrintQR(POSSDK pos_sdk,int printMode,String pszBuffer,int DataLength,int nOrgx,int iWeigth,int iSymbolType,int iLanguageMode) {
		...
		pszBuffer = "";
		error_code = pos_sdk.barcodePrintQR(pszBuffer,pszBuffer.length(), nOrgx, iWeigth, iSymbolType, iLanguageMode);
		if(error_code != POS_SUCCESS)
		{
			return error_code;
		}
	...
	public int TestPrintBitmap(POSSDK pos_sdk,int printMode,String img_name,int img_type) {
		...
		else if(img_type == 2)
		{
			...
			//download bitmap
			error_code = pos_sdk.imageStandardModeGrayPrint(image, PrinterWidth);
			if(error_code !=POS_SUCCESS)
			{
				return error_code;
			}
	...
	public int TestUserDefinedCharacter(POSSDK pos_sdk,int printMode)
	{
		...
		String path =  
				"/storage/emulated/0/data/1.bmp" + "@" + 
			    "/storage/emulated/0/data/2.bmp" + "@" + 
			    "/storage/emulated/0/data/3.bmp";
	...
	public int TestRasterBitmap(POSSDK pos_sdk,int printMode,String str_data,int paintSize,int bold)
	{
		...
		error_code = pos_sdk.imageStandardModeRasterPrint(c_image,PrinterWidth,10);
		if(error_code != POS_SUCCESS)
		{
			return error_code;
		}	
...
//		}
		...
		//Query Status  com=2
		data_size = pos_sdk.systemQueryStatus(recbuf, 4, 2);
