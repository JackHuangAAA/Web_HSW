    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_takepic:
                ...
                String picPath = UVCCameraHelper.ROOT_PATH +  DIRECTORY_NAME +"/images/"+ System.currentTimeMillis()
            ...
            case R.id.menu_recording:
                ...
                if (!mCameraHelper.isPushing()) {
                    String videoPath = UVCCameraHelper.ROOT_PATH +  DIRECTORY_NAME +"/videos/"+ System.currentTimeMillis();
