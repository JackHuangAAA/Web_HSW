<template>
  <div class="layout">
      ...
      <div class="layout-nav-wrap">
        ...
        <div class="layout-menu">
          <div v-for="(menu, index) in menus"
               ...
               :class="currentPath == menu.url? 'active':''">
            <div>
          ...
          <Dropdown>
            ...
            <DropdownMenu slot="list"
              ...
              <DropdownItem @click.native="setting">
                <div style="display: inline-block;vertical-align: middle;"><img src="~@/assets/passwd.png"></img></div>
                <div style="display: inline-block;margin-left: 12px;margin-right: 4px;">修改密码</div>
              </DropdownItem>
              <DropdownItem @click.native="logout">
                <div style="display: inline-block;vertical-align: middle;"><img src="~@/assets/logout.png"></img></div>
    ...
    <div class="layout-main">
      <router-view ref="contentView"
                   class="layout-main-page"></router-view>
      <Spin fix
            v-show="loading">
        <Icon type="load-c"
              size=18
    ...
    <Modal ref="settingModal"
      ...
      <Form ref="frmSetting"
        ...
        <FormItem label="请输入旧密码"
                  prop="password">
          <Input type="password"
                 v-model="frmSetting.password"
                 placeholder=""></Input>
        </FormItem>
        <FormItem label="请输入新密码"
                  prop="newpassword">
          <Input type="password"
                 v-model="frmSetting.newpassword"
                 placeholder=""></Input>
        </FormItem>
        <FormItem label="请确认新密码"
                  prop="newpassword1">
          <Input type="password"
                 v-model="frmSetting.newpassword1"
                 placeholder=""></Input>
        </FormItem>
      </Form>
      <div slot="footer">
        <Button @click="cancelSetting('frmSetting')"
                style="margin-right:10px; height: 36px; width:88px;">取 消</Button>
        <Button type="primary"
                @click="saveSetting('frmSetting')"
                style="height: 36px; width:88px;">保 存</Button>
      </div>
    </Modal>
  </div>
</template>
